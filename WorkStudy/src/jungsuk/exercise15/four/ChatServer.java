...
class ChatServer extends Frame {
	...
	void startServer() {
		...
		try {
			/*
			 * (1) 아래의 로직에 맞게 코드를 작성하시오. 1. 서비소켓을 생성하여 7777번 포트와 결합시킨다. 2. ta에
			 * "서버가 준비되었습니다."라고 보여준다. 3. 상대방의 연결을 기다린다. 4. ta에 "상대방과 연결되었습니다."라고
			 * 보여준다. 5. 연결된 상대방 소켓의 입력스트림과 출력스트립을 얻어온다. 6. 반복문을 이용해서 입력스트림이
			 * null이 아닌 동안 입력스트림으로부터 데이터를 읽어서 ta에 append한다.
			 */
