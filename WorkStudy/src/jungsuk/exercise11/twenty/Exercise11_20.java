...
class Exercise11_20 {
	static ArrayList<Object> record = new ArrayList<Object>(); // 성적데이터를 저장할 공간
	...
	static int displayMenu() {
		 ...
		 * 2. 1~3사이의 값을 입력받지 않으면, 메뉴의 선택이 잘못되었음을 알려주고 다시 입력받는다.(유효한 값을 입력받을 때까지
		 * 반복해서 입력받는다.)
		 */
		...
		do {
			...
			if (menu >=1 && menu <=3)
				...
				System.out.println("메뉴의 선택이 잘못되었습니다. 다시 입력해주세요..");
				System.out.print("원하는 메뉴를 선택하세요.(1~3) : ");
			}
		} while (true);
			...
			if (input.equalsIgnoreCase("q"))
				...
				try {
					if (!input.equalsIgnoreCase("q")) {
						...
						System.out.println("입력이 되었습니다. 입력을 마치려면 q를 입력하세요.");
					} else {
						return;
					}
				} catch (Exception e) { 
